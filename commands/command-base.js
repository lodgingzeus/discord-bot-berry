...
module.exports = (commandOptions) => {
    ...
    // console.log(`Before: ${typeof commands}`)
    if (typeof commands === 'string') {
        commands = [commands]
    }
    // console.log(`After: ${typeof commands}`)
...
//     //ensure that command and aliases are in array
//     console.log(`Before: ${typeof commands}`)
//     if(typeof commands === 'string'){
//         commands = [commands]
...
//     //ensure permissions are in array and valid
//     if(permissions.length){
//         if(typeof permissions === 'string'){
//             permissions = [permissions]
//         }
...
//                     message.reply(`You need "${requiredRole}" role to run this command`)
//                     return
//                 }
//                 }
